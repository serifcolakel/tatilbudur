...
export default function DiscountContact() {
  return (
    <div className="md:w-full md:h-[250px] w-11/12 h-[410px] bg-[#FEC610] flex flex-row  justify-between rounded-3xl overflow-hidden ">
      <div className="hidden md:flex md:w-[467px] md:h-[250px] ">
        <img
          src="/images/model.png"
          alt="modal"
          className="object-cover h-full rounded-2xl md:pl-4"
        />
      </div>
      <div className="flex flex-col md:items-start md:justify-start md:w-5/6 md:pl-16 md:pt-8">
        <p className="text-[#3F536C] md:text-[24px] text-[20px] font-semibold p-4">
          Üyelere özel indirimlere ve harika fiyatlara erişim
          <br className="md:hidden block" /> sağlayın
        </p>
        <div className="flex md:flex-row flex-col gap-y-2 gap-x-8">
          <div className="flex flex-col gap-y-4 pl-4 pr-4 ">
            ...
            >
              ...
              <div className="absolute w-full inset-y-0 left-0 flex items-center px-2 color hover pl-4  focus:stroke-red-700">
                <svg
                  ...
                  width="16.052"
                  height="12.841"
                  viewBox="0 0 16.052 12.841"
                >
                  <path
                    id="mail"
                    d="M17.447,6H4.605a1.6,1.6,0,0,0-1.6,1.605L3,17.236a1.61,1.61,0,0,0,1.605,1.605H17.447a1.61,1.61,0,0,0,1.605-1.605V7.605A1.61,1.61,0,0,0,17.447,6Zm0,11.236H4.605V9.21l6.421,4.013L17.447,9.21Zm-6.421-5.618L4.605,7.605H17.447Z"
            ...
            <div className="flex gap-x-2 bg-[#FEC610]">
              <input
                className="h-5 w-5 checked:bg-[#FEC610] rounded-sm"
                type="checkbox"
                value=""
                id="flexCheckChecked"
              />
              <label
                className=" text-[#4E5C64] text-[14px] inline-block"
                htmlFor="flexCheckChecked"
              >
                <strong> %50’ye varan</strong> Fırsat ve Kampanyalardan <br />
          ...
          <div className="flex flex-row justify-between w-full ">
            ...
            <div className="md:hidden relative bottom-[70px] left-[80px] pt-12">
              <img
                src="/images/shutterstock_1464020855.png "
                alt="model-reverse"
                className="object-cover rounded-3xl ml-8 mt-2"
              />
            </div>
          </div>
        </div>
